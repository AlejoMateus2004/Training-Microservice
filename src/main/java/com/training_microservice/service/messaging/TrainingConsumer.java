...
public class TrainingConsumer {
    ...
    public void getTrainerTrainingListByTrainingParams(Message message){
        ...
        try {
            ...
            log.error(ex.getMessage());
            producer.sendMessage("queue.trainerTrainingList.response", ResponseEntity.notFound(), processId);
        }
    ...
    public void getTraineeTrainingListByTrainingParams(Message message){
        ...
        try {
            ...
            log.error(ex.getMessage());
            producer.sendMessage("queue.traineeTrainingList.response", ResponseEntity.notFound(), processId);
        }
    }
